 ...
 * Tasks (ROADMAP.md Milestone 4), and Calendar & Scheduling (Milestone 5)
 * exist. Notes/AI Chat remain stubbed with ComingSoonPage as quick-action
 * targets until their own milestones (6, 7) build them.
 */
